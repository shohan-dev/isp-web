      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <?= form_dropdown('designation', [
            ...
            'lineman'   => 'Lineman',
            'manager'   => 'Manager',
          ], $details->designation, 'class="form-control"'); ?>
        ...
        <div class="form-group">
          ...
          echo form_dropdown('area_id[]', $data, explode(',', $details->area_id), 'class="form-control" multiple="multiple"');
          ?>
...
<script>
  $("#form").submit(function(e) {
    ...
    $.ajax({
      url: '<?= route_to('route.employee.update', $details->id); ?>',
      type: 'POST',
      ...
      success: function(result) {
        ...
        $(form).find('button[type="submit"]').html('Update Employee');

        $(form).find('button[type="submit"]').removeAttr('disabled');

        tata.success('Employee updated', result.response, {
          onClose: () => {
      ...
      error: function({
        ...
        if (result.status === 'validation-error') {
          ...
          tata.error("Couldn't update employee", result.response);
        }
      }
    });
