<nav class="lp-nav" id="lp-nav" aria-label="Main navigation">
    <div class="lp-nav__inner">
        ...
        <ul class="lp-nav__links">
            ...
            <li><a href="#lp-how-it-works">How it works</a></li>
            <li><a href="#lp-pricing">Pricing</a></li>
            <li><a href="#lp-proof">Trusted By</a></li>
            <li><a href="#lp-contact">Contact</a></li>
        </ul>
        <div class="lp-nav__actions">
            ...
            <?php endif; ?>
            <a href="#lp-contact" class="lp-btn lp-btn--outline lp-btn--sm" data-lp-inquiry="Demo Request">Book Demo</a>
