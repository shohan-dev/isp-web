...
<div class="box box-warning">
      ...
      <div class="box-body">
        ...
        <div class="table-responsive">
          ...
          <caption class="sr-only">POP payment history</caption>
          <thead class="text-nowrap">
            <tr>
              ...
              <th scope="col" data-data="month">Month</th>
              <th scope="col" data-data="created_at">Invoice Date</th>
              <th scope="col" data-data="paid_at">Payment Date</th>
              <th scope="col" data-data="paid_to">Paid To</th>
              <th scope="col" data-data="paid_via">Paid Via</th>
              <th scope="col" data-data="method_trx">Trx Id</th>
