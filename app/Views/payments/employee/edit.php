          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <?= form_input([
                'type'      => 'text',
                'class'     => 'form-control',
                'value'     => getUserArea($details->user_id) ? getUserArea($details->user_id)->area_name.' ('.getUserArea($details->user_id)->area_code.')' : '--',
                'readonly'  => 'readonly'
              ]); ?>
            </div>
...
<?= $this->section('script'); ?>
  ...
  <script>
    $("#form").submit(function(e) {
        ...
        $.ajax({
          url: '<?= route_to('route.employee.payment.update', $details->id); ?>',
          type: 'POST',
