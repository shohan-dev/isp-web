<?= $this->extend('layout/main-layout_api'); ?>
...
<div class="row">
      ...
      <?php if (getSetting('enable_bkashpg') == 'yes') : ?>
            ...
            <div class="box-body bg-bkash">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td><?= $bkash_charge; ?>৳ (<?= getSetting('bkashpg_charge'); ?>%)</td>
                </tr>
                <tr>
      ...
      <?php if (getSetting('enable_nagadpg') == 'yes') : ?>
          ...
          <div class="box border-nagad">
            ...
            <div class="box-body bg-nagad">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  <th scope="row">Charge</th>
                  <td><?= $nagad_charge; ?>৳ (<?= getSetting('nagadpg_charge'); ?>%)</td>
                </tr>
                <tr>
                  <th scope="row">Total</th>
      ...
      <?php if (getSetting('enable_sslcommerz') == 'yes') : ?>
          ...
          <div class="box border-sslcommerz">
            ...
            <div class="box-body bg-sslcommerz">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  <th scope="row">Charge</th>
                  <td><?= $sslcommerz_charge; ?>৳ (<?= getSetting('sslcommerz_charge'); ?>%)</td>
                </tr>
                <tr>
                  <th scope="row">Total</th>
      ...
      <?php if (getSetting('enable_eps') == 'yes') : ?>
          ...
          <div class="box border-eps">
            ...
            <div class="box-body bg-eps">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  <th scope="row">Charge</th>
                  <td><?= $eps_charge; ?>৳ (<?= getSetting('eps_charge'); ?>%)</td>
                </tr>
                <tr>
                  <th scope="row">Total</th>
      ...
      <?php if (getSetting('enable_shurjopay') == 'yes') : ?>
          ...
          <div class="box border-shurjopay">
            ...
            <div class="box-body bg-shurjopay">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  <th scope="row">Charge</th>
                  <td><?= $shurjopay_charge; ?>৳ (<?= getSetting('shurjopay_charge'); ?>%)</td>
                </tr>
                <tr>
                  <th scope="row">Total</th>
      ...
      <?php if (getSetting('enable_paystation') == 'yes') : ?>
          ...
          <div class="box border-paystation">
            ...
            <div class="box-body bg-paystation">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  <th scope="row">Charge</th>
                  <td><?= $paystation_charge; ?>৳ (<?= getSetting('paystation_charge'); ?>%)</td>
                </tr>
                <tr>
                  <th scope="row">Total</th>
