                                    ...
                                    <td>
                                        <?php if (userHasPermission('inventory_purchess', 'update')) : ?>
                                            <button class="btn btn-xs btn-primary editProviderBtn"
                                                ...
                                                data-bs-placement="bottom" title="Edit" aria-label="Edit provider">
                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                            </button>
                                        <?php endif; ?>
                                        <?php if (userHasPermission('inventory_purchess', 'read')): ?>
                                            ...
                                            <button class="btn btn-xs btn-info viewProviderBtn" data-id="<?= $provider['id'] ?>"
                                                ...
                                                data-address="<?= esc($provider['address']) ?>"
                                                data-image="<?= esc($provider['image']) ?>" data-bs-toggle="tooltip"
                                                data-bs-placement="bottom" title="Details" aria-label="View provider details">
