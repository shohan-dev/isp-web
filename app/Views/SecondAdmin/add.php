                                ...
                                <select class="form-control" id="package" name="package" required>
                                    ...
                                    <?php foreach ($packages as $package): ?>
                                        <option value="<?= $package['id'] ?>"
                                            data-bandwidth="<?= $package['bandwidth_allocation'] ?>"
                                            data-package-details="<?= $package['package_details'] ?>">
...
<?php endif; ?>
                            ...
                            <div class="form-group col-md-6">
                                <label for="package">Select Your Preferable Package *</label>
                                <button type="button" id="package-info" class="btn btn-primary col-md-12" disabled>Customers: Sign Up Fee: Month Fee:</button>
                            </div>
                        </div>
                    </div>
                </div>
