            ...
            <ul class="list-group list-group-unbordered">
              ...
              <li class="list-group-item">
                ...
                <span class="pull-right">
                  <?= getAdminPackage($details->id)['package_name'] ?? '--'; ?>
                </span>
              ...
              <li class="list-group-item">
                <b>Reg. At</b>
                <span class="pull-right">
                  <?= $formatDetailDate($details->created_at ?? null); ?>
                </span>
              </li>
              ...
              <li class="list-group-item">
                <b>Updated At</b>
                <span class="pull-right">
                  <?= $formatDetailDate($details->updated_at ?? null); ?>
                </span>
              </li>
          ...
          <div class="box-body">
            ...
            <ul class="list-group list-group-unbordered">
              ...
              <li class="list-group-item">
                ...
                <span class="pull-right">
                  <?php
                  $package = getAdminPackage($details->id);
              ...
              <li class="list-group-item">
                <b>Last Renewed</b>
                <span class="pull-right">
                  <?= $formatDetailDate($details->last_renewed ?? null); ?>
                </span>
              </li>
              ...
              <li class="list-group-item">
                <b>Expire Date</b>
                <span class="pull-right">
                  <?= $formatDetailDate($details->will_expire ?? null); ?>
                </span>
              </li>
            </ul>
          </div>
