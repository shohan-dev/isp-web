 ...
 *   https://datatables.net/download/#bs5/dt-1.13.4/r-2.4.1/sl-1.6.2
 *
 * Included libraries:
 *  DataTables 1.13.4, Responsive 2.4.1, Select 1.6.2
 */
/*! DataTables 1.13.4
...
! function(n) {
    ...
    var Ie = [],
        ...
        He = (e("columns()", function(n, a) {
            ...
            buttons: {},
            classes: {},
            builder: "bs5/dt-1.13.4/r-2.4.1/sl-1.6.2",
            errMode: "alert",
            feature: [],
            search: [],
            selector: {
        ...
        e = (f.extend(d.prototype, {
            ...
            _classLogic: function() {
                function d(e, t, n, i) {
                    ...
                    if (n) {
                        if ("max-" === n)
                            ...
                            for (s = 0, o = l.length; s < o; s++) - 1 === l[s].name.indexOf(i) && u(e, l[s].name)
                ...
                var a = this,
                    ...
                    u = function(e, t) {
                        e = c[e].includeIn; - 1 === f.inArray(t, e) && e.push(t)
                    };
                c.each(function(e, r) {
...
! function(o) {
    ...
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs5", "datatables.net-responsive"], function(e) {
    ...
    }) : "object" == typeof exports ? (a = require("jquery"), n = function(e, d) {
        ...
        return e = e || window, d = d || a(e), n(e, d), o(d, e, e.document)
    } : (n(window, a), module.exports = o(a, window, window.document))) : o(jQuery, window, document)
}(function(i, e, d, o) {
    "use strict";
    var s, a = i.fn.dataTable,
        n = a.Responsive.display,
        l = n.modal,
        r = i('<div class="modal fade dtr-bs-modal" role="dialog"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><div class="modal-body"/></div></div></div>'),
        u = e.bootstrap;
    return a.Responsive.bootstrap = function(e) {
        u = e
    }, n.modal = function(t) {
        return s = s || new u.Modal(r[0]),
            function(e, d, o) {
                var a, n;
                i.fn.modal ? d || (t && t.header && (n = (a = r.find("div.modal-header")).find("button").detach(), a.empty().append('<h4 class="modal-title">' + t.header(e) + "</h4>").append(n)), r.find("div.modal-body").empty().append(o()), r.appendTo("body").modal(), s.show()) : l(e, d, o)
            }
    }, a
});
...
! function(l) {
    ...
    function s(e) {
        ...
        m(e.table().container()).off("mousedown.dtSelect", t).off("mouseup.dtSelect", t).off("click.dtSelect", t), m("body").off("click.dtSelect" + p(e.table().node()))
    }

    function c(o) {
        var a, t = m(o.table().container()),
            l = o.settings()[0],
        ...
        t.on("mousedown.dtSelect", s, function(e) {
            ...
            if (a) {
                ...
                if ((!s.anchorNode || m(s.anchorNode).closest("table")[0] === o.table().node()) && s !== a) return
            }
            var c, s = o.settings()[0],
    ...
    function n(o) {
        var i = new _.Api(o);
        o._select_init = !0, o.aoRowCreatedCallback.push({
            fn: function(e, t, l) {
                var s, c, n = o.aoData[l];
                for (n._select_selected && m(e).addClass(o._select.className), s = 0, c = o.aoColumns.length; s < c; s++)(o.aoColumns[s]._select_selected || n._selected_cells && n._selected_cells[s]) && m(n.anCells[s]).addClass(o._select.className)
            },
            ...
            t === i.settings()[0] && (l = i.rows({
                ...
                i.rows(l).select(), s.any() && s.each(function(e) {
            ...
            m(i.rows({
                selected: !0
            }).nodes()).removeClass(i.settings()[0]._select.className), s(i), i.off(".dtSelect"), m("body").off(".dtSelect" + p(i.table().node()))
        })
    }
    ...
    function d(e, t, l, s) {
        ...
        e[t + "s"]({
            selected: !0
        }).any() || -1 !== s ? (o < s && (c = o, o = s, s = c), n.splice(o + 1, n.length), n.splice(0, s)) : n.splice(m.inArray(l, n) + 1, n.length), e[t](l, {
            selected: !0
    ...
    _.select = {}, _.select.version = "1.6.2", _.select.init = function(c) {
        ...
        f._select || (e = c.state.loaded(), t = function(e, t, l) {
            ...
            l.select = {}, l.select.rows = c.rows({
                selected: !0
            }).ids(!0).toArray(), l.select.columns = c.columns({
                selected: !0
            })[0], l.select.cells = c.cells({
                selected: !0
            })[0].map(function(e) {
                return {
        ...
        _.ext.selector[i.type].push(function(e, t, l) {
            var s, c = t.selected,
                n = [];
            if (!0 !== c && !1 !== c) return l;
            for (var o = 0, a = l.length; o < a; o++) s = e[i.prop][l[o]], (!0 === c && !0 === s._select_selected || !1 === c && !s._select_selected) && n.push(l[o]);
            return n
        })
        ...
        var s, c = t.selected,
            n = [];
        if (c === h) return l;
        for (var o = 0, a = l.length; o < a; o++) s = e.aoData[l[o].row], (!0 !== c || !s._selected_cells || !0 !== s._selected_cells[l[o].column]) && (!1 !== c || s._selected_cells && s._selected_cells[l[o].column]) || n.push(l[o]);
        return n
    });
    ...
    t("select()", function() {
        ...
        return l === h ? this.context[0]._select.style : this.iterator("table", function(e) {
            e._select || _.select.init(new _.Api(e)), e._select_init || n(e), e._select.style = l;
            var t = new _.Api(e);
        ...
        return t === h ? this.context[0]._select.selector : this.iterator("table", function(e) {
            s(new _.Api(e)), e._select.selector = t, "api" !== e._select.style && c(new _.Api(e))
        })
    }), l("rows().select()", "row().select()", function(e) {
        var l = this;
        return !1 === e ? this.deselect() : (this.iterator("row", function(e, t) {
            f(e), e.aoData[t]._select_selected = !0, m(e.aoData[t].nTr).addClass(e._select.className)
        ...
        return !1 === e ? this.deselect() : (this.iterator("column", function(e, t) {
            ...
            m(t.header()).addClass(e._select.className), m(t.footer()).addClass(e._select.className), t.nodes().to$().addClass(e._select.className)
        }), this.iterator("table", function(e, t) {
        ...
        return !1 === e ? this.deselect() : (this.iterator("cell", function(e, t, l) {
            f(e);
            t = e.aoData[t];
            t._selected_cells === h && (t._selected_cells = []), t._selected_cells[l] = !0, t.anCells && m(t.anCells[l]).addClass(e._select.className)
        }), this.iterator("table", function(e, t) {
        ...
        return this.iterator("row", function(e, t) {
            e.aoData[t]._select_selected = !1, e._select_lastCell = null, m(e.aoData[t].nTr).removeClass(e._select.className)
        }), this.iterator("table", function(e, t) {
        ...
        return this.iterator("column", function(s, e) {
            ...
            var t = new _.Api(s),
                l = t.column(e);
            m(l.header()).removeClass(s._select.className), m(l.footer()).removeClass(s._select.className), t.cells(null, e).indexes().each(function(e) {
        ...
        return this.iterator("cell", function(e, t, l) {
            t = e.aoData[t];
            t._selected_cells !== h && (t._selected_cells[l] = !1), t.anCells && !e.aoColumns[l]._select_selected && m(t.anCells[l]).removeClass(e._select.className)
        }), this.iterator("table", function(e, t) {
    ...
    return m.extend(_.ext.buttons, {
        selected: {
            ...
            init: function(l, e, s) {
                var c = this;
                s._eventNamespace = ".select" + v++, l.on(a(s), function() {
                    var e, t;
        ...
        selectedSingle: {
            ...
            init: function(t, e, l) {
                var s = this;
                l._eventNamespace = ".select" + v++, t.on(a(l), function() {
                    var e = t.rows({
                        selected: !0
        ...
        showSelected: {
            ...
            action: function(e, s, t, l) {
                ...
                }, _.ext.search.push(c), this.active(!0)), s.draw()
            }
        }
...
! function(n) {
    ...
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs5", "datatables.net-select"], function(e) {
        ...
        t.fn.dataTable || require("datatables.net-bs5")(e, t), t.fn.dataTable.select || require("datatables.net-select")(e, t)
    }, "undefined" != typeof window ? module.exports = function(e, t) {
