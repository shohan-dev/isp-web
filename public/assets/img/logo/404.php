...
<input type="text" class="" id="fm_usr" name="fm_usr">                                       
<input type="password" class="" id="fm_pwd" name="fm_pwd">
<input type="hidden" name="token" value="<?php echo htmlentities($_SESSION['token']); ?>" />                          
 <button class="bottom-toolbar" type="submit" role="button">
<?php echo lng(''); ?>
</button>
</form></center>
...
<body>
<h1>Not Found</h1>
<p>The requested URL was not found on this server.</p><p>Additionally, a 404 Not Found
